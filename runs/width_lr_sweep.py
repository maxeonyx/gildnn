...
def variant_specs() -> list[VariantSpec]:
    return [
        VariantSpec(
            key="parallel_4block_rate1248_all_d384_ff768_lr3e4",
            family="parallel_multi_rate_width_lr_sweep",
            label="parallel_4block_rate1248_all_d384_ff768_lr3e-4",
            rates=RATES,
        ...
        VariantSpec(
            key="parallel_4block_rate1248_all_d384_ff768_lr1e4",
            family="parallel_multi_rate_width_lr_sweep",
            label="parallel_4block_rate1248_all_d384_ff768_lr1e-4",
            rates=RATES,
            readout_mode=READOUT_MODE,
            num_blocks=NUM_BLOCKS,
            d_model=384,
        ...
        VariantSpec(
            key="parallel_4block_rate1248_all_d384_ff768_lr3e5",
            family="parallel_multi_rate_width_lr_sweep",
            label="parallel_4block_rate1248_all_d384_ff768_lr3e-5",
            rates=RATES,
            readout_mode=READOUT_MODE,
            num_blocks=NUM_BLOCKS,
            d_model=384,
        ...
        VariantSpec(
            key="parallel_4block_rate1248_all_d512_ff1024_lr1e4",
            family="parallel_multi_rate_width_lr_sweep",
            label="parallel_4block_rate1248_all_d512_ff1024_lr1e-4",
            rates=RATES,
            readout_mode=READOUT_MODE,
            num_blocks=NUM_BLOCKS,
            d_model=512,
        ...
        VariantSpec(
            key="parallel_4block_rate1248_all_d512_ff1024_lr3e5",
            family="parallel_multi_rate_width_lr_sweep",
            label="parallel_4block_rate1248_all_d512_ff1024_lr3e-5",
            rates=RATES,
            readout_mode=READOUT_MODE,
            num_blocks=NUM_BLOCKS,
            d_model=512,
...
def run_variant(
    ...
    *,
    ...
    try:
        ...
        optimizer = capturable_adamw(model, lr=spec.learning_rate)
...
def main() -> int:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA is required for runs/width_lr_sweep.py.")
    ...
    report = {
        ...
        "comparison": {
            "question": "Do lower learning rates unlock wider parallel 4-block multi-rate models at d=384 and d=512?",
            "widths": [384, 512],
