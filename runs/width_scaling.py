...
def main() -> int:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA is required for runs/width_scaling.py.")
    ...
    report = {
        ...
        "results": results,
        "comparison": {
            "question": "Does wider parallel 4-block compete with or beat sequential 6-block?",
            "baseline_parallel_key": "parallel_4block_rate1248_d128_ff256",
            "wider_parallel_key": "parallel_4block_rate1248_d256_ff512",
            "sequential_reference_key": "sequential_6block_rate1_d128_ff256",
        },
    }
