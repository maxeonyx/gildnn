...
def variant_specs() -> list[VariantSpec]:
    return [
        VariantSpec(
            key="parallel_4block_rate141632_d256_ff512_ctx128",
            family="parallel_multi_rate",
            label="parallel_4block_rate141632_all_d256_ff512_ctx128",
        ...
        VariantSpec(
            key="parallel_4block_rate12832_d256_ff512_ctx128",
            family="parallel_multi_rate",
            label="parallel_4block_rate12832_all_d256_ff512_ctx128",
            class_name="ParallelDiagonalModel",
            rates=(1, 2, 8, 32),
            readout_mode="all",
            d_model=256,
        ...
        VariantSpec(
            key="parallel_4block_rate1248_d256_ff512_ctx128",
            family="parallel_multi_rate_baseline",
            label="parallel_4block_rate1248_all_d256_ff512_ctx128",
            class_name="ParallelDiagonalModel",
            rates=(1, 2, 4, 8),
            readout_mode="all",
            d_model=256,
        ...
        VariantSpec(
            key="sequential_6block_rate1_d256_ff512_ctx128",
            family="sequential_all_rate_1",
            label="sequential_6block_rate111111_d256_ff512_ctx128",
...
def main() -> int:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA is required for runs/context_scaling.py.")
    ...
    report = {
        ...
        "results": results,
        "comparison": {
            "question": "Does longer context favor wider rate spacing over the established 1248 baseline?",
            "wide_spacing_key": "parallel_4block_rate141632_d256_ff512_ctx128",
            "moderate_spacing_key": "parallel_4block_rate12832_d256_ff512_ctx128",
            "baseline_parallel_key": "parallel_4block_rate1248_d256_ff512_ctx128",
            "sequential_reference_key": "sequential_6block_rate1_d256_ff512_ctx128",
        },
    }
