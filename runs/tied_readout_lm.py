...
from core.tied_readout import LONG_CONTEXT, MID_CONTEXT, SHORT_CONTEXT, ModelSize, TiedReadoutModel, interior_local_loss
    ...
    *,
    ...
    for cache_interval in cache_intervals:
        ...
        for start in range(0, precomputed.targets.shape[0], batch_size):
            ...
            with autocast_context(device):
                logits = model.output_logits_from_hidden(output_hidden, mid_hidden=mid_hidden, long_hidden=long_hidden)
