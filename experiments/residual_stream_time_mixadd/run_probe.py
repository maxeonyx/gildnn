...
def write_metadata(
    ...
    *,
    ...
    write_json(
        ...
        {
            "model_family": "residual_stream_time_mixadd",
            "dictation_source": "dictations/2026-05-21-1.md",
...
def main() -> None:
    ...
    output_dir = args.output_dir or (
        args.repo_root / "experiments" / "residual_stream_time_mixadd" / "artifacts" / args.stage
    )
    ...
    if args.stage == "overfit":
        ...
        write_loss_curve_svg(
            ...
            title="Residual stream across time mix-add: overfit one batch",
    ...
    write_loss_curve_svg(
        ...
        title="Residual stream across time mix-add: tiny run",
        series={
