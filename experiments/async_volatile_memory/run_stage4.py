...
def main() -> None:
    ...
    output_dir = args.output_dir or (args.repo_root / "experiments" / "async_volatile_memory" / "artifacts" / "stage4")
    ...
    print("PASS async volatile memory stage4")
    print(f"Wrote {output_path}")
    print(json.dumps({
        "synchronous_control": {"memorized": sync_result["memorized"], "hit_step": sync_result["hit_step"], "final_loss": sync_result["final_loss"], "final_accuracy": sync_result["final_accuracy"]},
        "async_stale_reads": {"memorized": async_result["memorized"], "hit_step": async_result["hit_step"], "final_loss": async_result["final_loss"], "final_accuracy": async_result["final_accuracy"]},
    }, indent=2))
