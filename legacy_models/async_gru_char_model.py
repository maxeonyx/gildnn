...
def make_sync_variant(config: AsyncGRUConfig) -> VariantSpec:
    return VariantSpec(
...
def make_async_zero_variant(config: AsyncGRUConfig) -> VariantSpec:
    return VariantSpec(
...
def make_async_stale_variant(config: AsyncGRUConfig) -> VariantSpec:
    return VariantSpec(
...
class AsyncGRUCharModel(nn.Module):
    def __init__(self, *, vocab_size: int, config: AsyncGRUConfig, variant: VariantSpec) -> None:
        super().__init__()
